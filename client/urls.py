...
urlpatterns = [
    ...
    path("account-settings", views.account_management, name="account-settings"),
    path(
        "create-subscription/<subID>/<plan>",
    ...
    path(
        "paypal-update-sub-confirmed",
        views.paypal_update_sub_confirmed,
        name="paypal-update-sub-confirmed",
    ),
    path(
        "django-update-sub-confirmed/<subID>",
        views.django_update_sub_confirmed,
        name="django-update-sub-confirmed",
    ),
